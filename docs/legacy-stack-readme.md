...
> **Important status notice:** Copper Kitchen **permanently closed on 26 October 2025**. This site is a historical portfolio / legacy tribute to the restaurant and the meals shared at 75 Sheep Street. No Copper Kitchen email address is verified, so none is published; booking forms are disabled via the `reservations_enabled` and `permanently_closed` settings.
...
The seed script inserts **only verified content**: the closure status and real contact details (01869 240877 / +441869240877, 75 Sheep Street), plus Tripadvisor-sourced testimonials. No prices, no unverified email addresses, no unverified images, and no invented reviews.
